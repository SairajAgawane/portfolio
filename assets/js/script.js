...
// ----------------------
// Typed.js – Subtitle & Terminal
// ----------------------
if (typeof Typed !== 'undefined') {
    new Typed('.typing-text', {
        strings: ['Software Developer', 'AI Developer', 'Machine Learning Enthusiast'],
    ...
    new Typed('.typed-terminal', {
        ...
        typeSpeed: 30, showCursor: true, cursorChar: '_', loop: false,
        onComplete: function () {
            setTimeout(() => {
...
if (typeof TagCloud !== 'undefined') {
    ...
    TagCloud('#skill-sphere', SkillSphereText, {
...
if (typeof ScrollReveal !== 'undefined') {
    ...
    ScrollReveal().reveal('.modern-project-card',                 { delay: 200, origin: 'bottom', interval: 150, distance: '40px' });
}
...
if (typeof tsParticles !== 'undefined') {
    tsParticles.load("tsparticles", {
        ...
        particles: {
            ...
            color: { value: ["#ef4444", "#f87171", "#ffffff"] },
            links: { enable: true, color: "#ef4444", distance: 150, opacity: 0.15, width: 1 },
...
if (terminalInput) {
    ...
    terminalInput.addEventListener("keydown", function (e) {
        if (e.key === "Enter") {
            ...
            if      (command === "github")    window.open("https://github.com/SairajAgawane", "_blank");
            else if (command === "instagram") window.open("https://instagram.com", "_blank");
            else if (command === "linkedin")  window.open("https://linkedin.com/in/SairajAgawane", "_blank");
            else if (command === "whatsapp")  window.open("https://wa.me/", "_blank");
            else if (command === "about")      document.getElementById("about").scrollIntoView({ behavior: "smooth" });
            else if (command === "skills")     document.getElementById("skills").scrollIntoView({ behavior: "smooth" });
            else if (command === "projects")   document.getElementById("projects").scrollIntoView({ behavior: "smooth" });
            else if (command === "experience") document.getElementById("experience").scrollIntoView({ behavior: "smooth" });
            else if (command === "contact")    document.getElementById("contact").scrollIntoView({ behavior: "smooth" });
        ...
        if (e.key === "ArrowUp") {
            if (historyIndex > 0) { historyIndex--; terminalInput.value = history[historyIndex]; }
        }
        if (e.key === "ArrowDown") {
...
// ----------------------
(function () {
    const carouselCards = document.querySelectorAll('.project-carousel');
    ...
    carouselCards.forEach(carousel => {
        ...
        const autoTimer = setInterval(() => {
            ...
            updateCarousel(carousel, current);
        }, 3000);
...
function carouselPrev(btn) {
    ...
    const current  = (carousel._current || 0);
    updateCarousel(carousel, (current - 1 + total) % total);
}
...
function carouselNext(btn) {
    ...
    const total    = carousel.querySelectorAll('.carousel-slide').length;
    const current  = (carousel._current || 0);
    updateCarousel(carousel, (current + 1) % total);
}

function carouselGoTo(dotsContainer, index) {
    const carousel = dotsContainer.closest('.project-carousel');
